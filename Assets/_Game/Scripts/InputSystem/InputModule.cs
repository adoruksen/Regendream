...
namespace InputSystem
{
    ...
    public abstract class InputModule : ScriptableObject
    {
        ...
        [FoldoutGroup("Debug"), BoxGroup("Debug/Deltas", false)] [SerializeField, DisableIf("$ReadOnly")]
        protected Vector2 _delta;

        public virtual Vector2 Delta => _delta;

        [BoxGroup("Debug/Deltas", false)] [SerializeField, DisableIf("$ReadOnly")]
        protected Vector2 _offset;

        public virtual Vector2 Offset => _offset;

        [BoxGroup("Debug/Deltas", false)] [SerializeField, DisableIf("$ReadOnly")]
        protected Vector2 _normalizedDelta;
        ...
        [BoxGroup("Debug/Positions", false)] [SerializeField, DisableIf("$ReadOnly")]
        protected Vector2 _downPosition;
        ...
        [ShowInInspector, DisableIf("$ReadOnly")]
        public virtual bool MouseDown => Input.GetMouseButtonDown(0);

        [BoxGroup("Debug/Bools", false)]
        [ShowInInspector, DisableIf("$ReadOnly")]
        public virtual bool MouseHold => Input.GetMouseButton(0);

        [BoxGroup("Debug/Bools", false)]
        [ShowInInspector, DisableIf("$ReadOnly")]
        public virtual bool MouseUp => Input.GetMouseButtonUp(0);
